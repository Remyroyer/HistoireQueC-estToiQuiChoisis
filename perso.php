...
if(!is_null($resultat)){
  ...
  ?>
        ...
        <td><input name="nomPerso" value="<?php echo $resultat[$a]['nomPerso'];?>" hidden><?php echo $resultat[$a]['nomPerso'];?></td>
        <td><input name="sexePerso" value="<?php echo $resultat[$a]['sexePerso'];?>" hidden><?php echo $resultat[$a]['sexePerso'];?></td>
